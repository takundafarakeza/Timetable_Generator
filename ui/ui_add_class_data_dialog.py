...
"}")
        ...
        self.class_save.setGeometry(QRect(540, 370, 81, 30))
...
"border-radius: 3px;")
        ...
        self.slots_per_day.setGeometry(QRect(170, 175, 101, 30))
        ...
        self.class_add_subject_btn.setGeometry(QRect(40, 240, 71, 30))
...
"border-radius: 3px;")
        ...
        self.title_2.setGeometry(QRect(170, 150, 91, 20))
        ...
        self.slots_per_cycle.setGeometry(QRect(40, 175, 111, 30))
        self.slots_per_cycle.setMinimumSize(QSize(0, 30))
        self.slots_per_cycle.setMinimum(0)
        self.class_teacher_select = QComboBox(self.frame)
        self.class_teacher_select.setObjectName(u"class_teacher_select")
        self.class_teacher_select.setGeometry(QRect(40, 100, 231, 30))
        self.class_teacher_select.setMinimumSize(QSize(0, 30))
        self.class_subject_select = QComboBox(self.frame)
        self.class_subject_select.setObjectName(u"class_subject_select")
        self.class_subject_select.setGeometry(QRect(40, 50, 231, 30))
        ...
        self.class_name.setGeometry(QRect(40, 20, 241, 21))
    ...
    def retranslateUi(self, AddClass):
        ...
        self.label.setText(QCoreApplication.translate("AddClass", u"Class Subject", None))
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("AddClass", u"Subjects", None));
        ...
        self.class_teacher_select.setPlaceholderText(QCoreApplication.translate("AddClass", u"Select Teacher", None))
