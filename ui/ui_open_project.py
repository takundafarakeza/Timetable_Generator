...
################################################################################
## Form generated from reading UI file 'open_projectvjBUpP.ui'
##
...
class Ui_Projects(object):
    def setupUi(self, Projects):
        ...
        Projects.resize(376, 489)
        Projects.setStyleSheet(u"* {\n"
...
"}")
        ...
        self.main_container = QWidget(Projects)
        ...
        self.close_btn.setGeometry(QRect(340, 0, 35, 30))
        ...
        self.label.setGeometry(QRect(70, 0, 241, 31))
        ...
        self.projects_table = QTableWidget(self.frame)
        if (self.projects_table.columnCount() < 1):
        ...
        self.projects_table.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.projects_table.setShowGrid(False)
        self.projects_table.horizontalHeader().setVisible(False)
        self.projects_table.horizontalHeader().setDefaultSectionSize(350)
        self.projects_table.verticalHeader().setVisible(False)

        self.verticalLayout_4.addWidget(self.projects_table)
    ...
    def retranslateUi(self, Projects):
        Projects.setWindowTitle(QCoreApplication.translate("Projects", u"Dialog", None))
        self.close_btn.setText("")
        self.label.setText(QCoreApplication.translate("Projects", u"Projects", None))
    # retranslateUi
